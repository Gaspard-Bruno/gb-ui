...
var Kanban = function Kanban(_ref) {
  ...
  var handleChangeColumn = (0, _react.useCallback)(function (params) {
    ...
    if (destinationColumn !== sourceColumn) {
      var COLUMNS = _objectSpread(_objectSpread({}, columns), {}, _defineProperty({}, sourceColumn, columns[sourceColumn].filter(function (c) {
        return c.id !== cardId;
      })));
  ...
  }, /*#__PURE__*/_react.default.createElement(_Layout.BackofficeKanbanContainer, null, columns && Object.keys(columns).map(function (key, index) {
...
Kanban.propTypes = {
  ...
  kanbanData: _propTypes.default.shape({
    admins: _propTypes.default.object,
    clients: _propTypes.default.object,
    services: _propTypes.default.object
  }),
  colNames: _propTypes.default.arrayOf(_propTypes.default.string),
  onChangeStatus: _propTypes.default.func
};