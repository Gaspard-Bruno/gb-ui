...
export default {
  ...
  about: {
    header: {
      title: "Sobre Nós",
      subtitle:
        "Proporcionamos uma vida activa a todos aqueles com mais de 55 anos de idade",
      body:
  ...
  footer: {
    ...
    about: "Sobre",
    services: "Serviços",
    becomeSpecialist: "Torne-se num Especialista",
    faqs: "FAQs",
  ...
  footerPages: {
    FAQ: {
      ...
      FAQSubtitle:
        "Respondemos regularmente às mesmas perguntas aos nossos clientes e + especialistas. Aqui, abordaremos as perguntas mais comuns para ajuda-lo a entender melhor a 55+.",
      title:
        "Vivamus sagittis lacus vel augue laoreet rutrum faucibus dolor auctor",
      content:
        "Natoque penatibus et magnis dis parturient montes. Nullam id dolor id nibh ultricies vehicula ut id elit donec ullamcorper nulla non metus auctor fringilla."
    },
    TermsAndConditions: {
